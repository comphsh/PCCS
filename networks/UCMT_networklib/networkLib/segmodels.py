import time
from networks.UCMT_networklib.networkLib._utils import IntermediateLayerGetter
try:
    from torch.hub import load_state_dict_from_url
except ImportError:
    from torch.utils.model_zoo import load_url as load_state_dict_from_url
from networks.UCMT_networklib.networkLib.backbone import resnet
from networks.UCMT_networklib.networkLib._deeplabv3 import DeepLabHead, DeepLabV3, DeepLabHeadV3Plus
from networks.UCMT_networklib.networkLib._fcn import FCN, FCNHead
...
def deeplabv3_resnet50(pretrained=False, progress=True, in_channels=1, num_classes=21, aux_loss=None, **kwargs):
